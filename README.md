...
Solution: Customer data analysis is done on the give dataset, null values which were found in the income column has been replaced with mean value of the income. Various visualizations and interpretations have been done.
